...
NeverAnother er en Android-app udviklet i Kotlin med fokus på at omsætte en high-fidelity prototype til en funktionel mobilapplikation. Projektet samler design, navigation og brugerinput i et sammenhængende flow, hvor brugeren kan udforske appens indhold, indtaste målinger, se resultater og arbejde videre gennem flere skærme i samme oplevelse.
...
- En start- eller forside, som introducerer appens univers og visuelle identitet.
- En skærm til valg eller oprettelse af BH, hvor brugeren bevæger sig videre i flowet.
- En måleside, hvor brugeren indtaster sine mål, som senere bruges i appen.
- En resultatside, hvor input omsættes til et resultat eller en visning for brugeren.
- En profilside med personlige oplysninger og målinger.
...
NeverAnother er udviklet som et samarbejdsprojekt af holdet NeverAnotherBra med versionsstyring via GitHub. Repositoriets struktur og historik viser, at projektet er blevet bygget iterativt med fokus på både designimplementering og funktionel udvikling.
